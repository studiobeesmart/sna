...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>ESP Course | Learning Management System</title>
    ...
    <body class=" login" style="background-image: url('assets/pages/img/bg2.png')">
        <!-- BEGIN LOGO -->
        <div class="content"  style="background-color: #f38423; padding-top:0px; border-radius: 25px;">
        ...
        <div class="content"  style="background-color: #393e4c; margin-top:-50px">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="snalogin" method="post" id="login-form">
                ...
                <div class="alert alert-danger alert-dismissible fade in">
                    ...
                    <strong>Alert!</strong> Username and Password doesn't match Our Record!
                </div>
                @endif
                ...
                <div class="form-actions">
                    <button type="submit" class="btn green uppercase" name="register-btn" id="register-btn">Login</button>
                ...
                <div class="create-account" style="background-color: #3baa7f;">
                    <p>
                        <a href="/reg" id="register-btn"  name="register-btn" class="register-btn">Create an account</a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
